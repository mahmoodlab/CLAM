Tutorial for Patch-Based Approach (without annotations)
===========
...
Patches extracted from several example WSIs can be found in [**results/patches**](https://github.com/qinghezeng/CLAM/tree/master/results/patches) (to play with the follwoing steps). 
