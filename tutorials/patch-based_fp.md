...
Patches extracted from several example WSIs can be found in [**results/patches-fp**](https://github.com/qinghezeng/CLAM/tree/master/results/patches-fp) (to play with the follwoing steps). 
