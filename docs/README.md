...
## Fork Info: This fork adds tifffile support to avoid issues with openslide/PIL related to tiff file formats. This repo will not be supported once full support for tifffile is integrated. Currently, tifffile support is limited to patch, mask, and stitch generation. ##
